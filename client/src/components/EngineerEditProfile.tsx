        ...
        <div className="bg-white rounded-xl p-6 md:p-8 shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="border-t border-neutral-200 pt-6">
              <h3 className="text-base font-medium text-neutral-900 mb-4">Professional Information *</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-neutral-700 mb-2">Specialization *</label>
                  <input
                    type="text"
                    name="specialization"
                    value={editedProfile.specialization || ''}
                    onChange={handleInputChange}
                    placeholder="e.g., Irrigation Systems, Soil Science"
                    className="w-full px-3 py-2 border border-neutral-200 rounded-lg outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100"
                  />
                </div>

                <div>
                  <label className="block text-sm text-neutral-700 mb-2">Years of Experience *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm text-neutral-700 mb-2">Job Title</label>
                  <input
                    type="text"
                    name="jobTitle"
                    value={editedProfile.jobTitle || ''}
                    onChange={handleInputChange}
                    placeholder="e.g., Agricultural Engineer, Consultant"
                    className="w-full px-3 py-2 border border-neutral-200 rounded-lg outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100"
                  />
                </div>

                <div>
                  <label className="block text-sm text-neutral-700 mb-2">Company</label>
                  <input
                    type="text"
                    name="company"
              ...
              <div className="mt-4">
                <label className="block text-sm text-neutral-700 mb-2">Skills/Expertise (comma separated)</label>
                <input
                  type="text"
                  name="skills"
                  value={editedProfile.skills || ''}
                  onChange={handleInputChange}
                  placeholder="e.g., Water Management, Crop Planning, IoT Sensors"
                  className="w-full px-3 py-2 border border-neutral-200 rounded-lg outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100"
                />
              </div>

              <div className="mt-4">
                <label className="block text-sm text-neutral-700 mb-2">Certifications</label>
                <textarea
                  name="certifications"
            ...
            <div className="border-t border-neutral-200 pt-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm text-neutral-700 mb-2">LinkedIn</label>
                  <input
                    type="url"
                    name="linkedin"
                ...
                <div>
                  <label className="block text-sm text-neutral-700 mb-2">Languages</label>
                  <input
                    type="text"
                    name="languages"
                  ...
                  <div key={field.id} className="p-4 bg-neutral-50 rounded-lg space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., Awards, Publications, Projects"
                        className="w-full px-3 py-2 border border-neutral-200 rounded-lg outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100"
                      />
                    </div>
